        ...
        <>
            {user == null ? (
                ...
                <ul className="nav justify-content-end">
                    ...
                    <li className="nav-item">
                        <NavLink to={"/profile"}><img src={user.imageUrl ? user.imageUrl : user.gender == "Male" ? "male-profile.jpg" : "female-profile.jpg"} height={"54px"} width={"54px"}
                            alt={user.imageAlt} className="rounded-circle" /></NavLink>
                    </li>
                </ul>
            )}
        </>
