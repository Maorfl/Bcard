...
const CreateCard: FunctionComponent<CreateCardProps> = ({ userId }) => {
    ...
    let formik = useFormik({
        ...
        onSubmit: (values) => {
            ...
            addCard({ title: values.title, subtitle: values.subtitle, description: values.description, phone: values.phone, email: values.email, web: values.web, image: image, address: address, userId: userId, favoriteByUsers: [] })
                .then((res) => {
            ...
            <div className="container">
                ...
                <form onSubmit={formik.handleSubmit}>
                    ...
                    <div className="row justify-content-center">
                        <div className="col-md-4">
                            <button type="button" className="btn btn-outline-danger w-100" onClick={() => navigate(-1)}>CANCEL</button>
                        </div>
                        <div className="col-md-4">
